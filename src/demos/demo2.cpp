...
public:
    ...
    void run()
    {
        ...
        (void) instance->add_actor(actor3);
        (void) instance->add_actor(actor4);
        ...
        if (result) {
            ...
            (void) actor3->save_actor(path_actors + "actor3.csv");
            (void) actor4->save_actor(path_actors + "actor4.csv");
